...
| Arquivo | Formato | Para que serve o Gui? |
|---------|---------|---------------------|
...
Existem duas possibilidades, injetar os dados diretamente no prompt (Ctrl + C, Ctrl + V) ou carregar os arquivos via código, conforme exemplo abaixo:
